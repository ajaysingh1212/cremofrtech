...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.otherEmployee.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.other-employees.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('select_employee') ? 'is-invalid' : '' }}" name="select_employee_id" id="select_employee_id">
                    @foreach($select_employees as $id => $entry)
                        <option value="{{ $id }}" {{ old('select_employee_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('present_address') ? 'is-invalid' : '' }}" name="present_address" id="present_address">{!! old('present_address') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parmanent_address') ? 'is-invalid' : '' }}" type="text" name="parmanent_address" id="parmanent_address" value="{{ old('parmanent_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhar') ? 'is-invalid' : '' }}" type="text" name="aadhar" id="aadhar" value="{{ old('aadhar', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('working_days') ? 'is-invalid' : '' }}" name="working_days" id="working_days">
                    ...
                    @foreach(App\Models\OtherEmployee::WORKING_DAYS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('working_days', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
