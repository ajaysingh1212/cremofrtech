...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-selectUserTimeWorkTypes">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.timeWorkType.fields.select_user') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($timeWorkTypes as $key => $timeWorkType)
                        <tr data-entry-id="{{ $timeWorkType->id }}">
                            ...
                            <td>
                                {{ $timeWorkType->select_user->name ?? '' }}
                            </td>
                            <td>
                                {{ $timeWorkType->select_user->email ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-selectUserTimeWorkTypes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
