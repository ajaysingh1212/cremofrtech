...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.teacherTimeing.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.teacher-timeings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('classes_timeing') ? 'is-invalid' : '' }}" type="text" name="classes_timeing" id="classes_timeing" value="{{ old('classes_timeing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selecte_days') ? 'is-invalid' : '' }}" type="text" name="selecte_days" id="selecte_days" value="{{ old('selecte_days', '') }}">
