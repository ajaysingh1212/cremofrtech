<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('employee_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/students*") ? "c-show" : "" }} {{ request()->is("admin/teachers*") ? "c-show" : "" }} {{ request()->is("admin/other-employees*") ? "c-show" : "" }} {{ request()->is("admin/teacher-timeings*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('other_employee_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.other-employees.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/other-employees") || request()->is("admin/other-employees/*") ? "c-active" : "" }}">
                                <i class="fa-fw fab fa-accusoft c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.otherEmployee.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('teacher_timeing_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.teacher-timeings.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/teacher-timeings") || request()->is("admin/teacher-timeings/*") ? "c-active" : "" }}">
                                <i class="fa-fw far fa-clock c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.teacherTimeing.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('attendance_payroll_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/aattendances*") ? "c-show" : "" }} {{ request()->is("admin/payrolls*") ? "c-show" : "" }} {{ request()->is("admin/student-payrolls*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-credit-card c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.attendancePayroll.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('aattendance_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.aattendances.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/aattendances") || request()->is("admin/aattendances/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-address-card c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.aattendance.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('payroll_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.payrolls.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/payrolls") || request()->is("admin/payrolls/*") ? "c-active" : "" }}">
                                <i class="fa-fw fab fa-cc-amazon-pay c-sidebar-nav-icon">
                    ...
                    @endcan
                    @can('student_payroll_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.student-payrolls.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/student-payrolls") || request()->is("admin/student-payrolls/*") ? "c-active" : "" }}">
