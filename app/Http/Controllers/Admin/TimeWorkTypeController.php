...
class TimeWorkTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        $timeWorkTypes = TimeWorkType::with(['select_user', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.timeWorkTypes.create', compact('select_users'));
    }
    ...
    public function edit(TimeWorkType $timeWorkType)
    {
        ...
        $timeWorkType->load('select_user', 'created_by');

        return view('admin.timeWorkTypes.edit', compact('select_users', 'timeWorkType'));
    }
