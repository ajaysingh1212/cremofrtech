...
class TeacherController extends Controller
{
    ...
    public function index()
    {
        ...
        $teachers = Teacher::with(['select_teacher', 'courses', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        $select_teachers = User::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        $courses = Course::pluck('title', 'id');

        return view('admin.teachers.create', compact('courses', 'select_teachers'));
    }
    ...
    public function edit(Teacher $teacher)
    {
        ...
        $teacher->load('select_teacher', 'courses', 'created_by');

        return view('admin.teachers.edit', compact('courses', 'select_teachers', 'teacher'));
    }
