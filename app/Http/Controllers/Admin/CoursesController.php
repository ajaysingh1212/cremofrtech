...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        $courses = Course::with(['teacher', 'students', 'created_by', 'media'])->get();
    ...
    public function edit(Course $course)
    {
        ...
        $course->load('teacher', 'students', 'created_by');
    ...
    public function show(Course $course)
    {
        ...
        $course->load('teacher', 'students', 'created_by', 'selectCourseStudents', 'coursesTeachers');
